                ...
                <div class="col-md-12 pr-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb ml-1">
                            ...
                            <li class="breadcrumb-item"><a href="counsel.php">Counsel</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Chioma Chinyere Onyehara</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body pt-1">
                            <div class="row mb-3">
                                <div class="col-md-12 bg-success px-0">
                                    <img src="../img/people/chioma3.jpg" alt="" class="img-fluid">
                                </div>
                                <!--  -->
                                <!-- <div class="col-md-8 align-middle">
                                    <h5 class="align-middle m-0 p-0 mb-4">
                                        <span class="fa-stack fa-md">
                                            <i class="fas fa-circle fa-stack-2x"></i>
                                            <i class="fas fa-user fa-stack-1x fa-inverse"></i>
                                        </span>
                                        <p class="align-middle d-inline"> Surname First I.</p>
                                    </h5>
                                    <h5 class="align-middle m-0 p-0 mb-4">
                                        <span class="fa-stack fa-md">
                                            <i class="fas fa-circle fa-stack-2x"></i>
                                        ...
                                        <p class="align-middle d-inline"> surnamename@email.com</p>
                                    </h5>
                                    <h5 class="align-middle m-0 p-0 mb-4">
                                        <span class="fa-stack fa-md">
                                            <i class="fas fa-circle fa-stack-2x"></i>
                                        ...
                                        <p class="align-middle d-inline"> Surname name</p>
                                    </h5>
                                    <h5 class="align-middle m-0 p-0 mb-4">
                                        <span class="fa-stack fa-md">
                                            <i class="fas fa-circle fa-stack-2x"></i>
                                        ...
                                        <p class="align-middle d-inline"> Profile</p>
                                    </h5>
                                    <h5 class="align-middle m-0 p-0 mb-4">
                                        <span class="fa-stack fa-md">
                                            <i class="fas fa-circle fa-stack-2x"></i>
                                        ...
                                        <p class="align-middle d-inline"> Barcode</p>
                                    </h5>
                ...
                <div class="col-md-4">
                    ...
                    <div class="row align-middle mt-4">
                        <div class="col-md-3 offset-md-1 px-0">
                            <img src="../img/people/IkeNwankwuo.jpg" alt="" class="rounded-circle img-fluid">
                        </div>
                        <div class="col-md-8">
                            <h4 class="font-weight-bold mt-2 mb-0">Nwakwuo Ike</h4>
                            <p class="my-0">Managing Partner<br>
                                <a href="nwankwo_ike.php" class="text-info">View Full Bio</a>
                            </p>
                        </div>
                    </div>
                    <div class="row align-middle mt-4">
                        <div class="col-md-3 offset-md-1 px-0">
                            <img src="../img/people/JosephLawyer.jpg" alt="" class="rounded-circle img-fluid">
                        </div>
                        <div class="col-md-8">
                            <h4 class="font-weight-bold mt-2 mb-0">Joseph Ekere</h4>
                            <p class="my-0">Lawyer<br>
                                <a href="joseph.php" class="text-info">View Full Bio</a>
                            </p>
                        </div>
                    </div>
                </div>
