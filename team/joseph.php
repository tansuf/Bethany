      ...
      <div class="container mt-5">
                ...
                <div class="col-md-12 pr-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb ml-1">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Joseph Ekere</li>
                        </ol>
                    </nav>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="row align-middle mt-4">
                        <div class="col-md-3 offset-md-1 px-0">
                            <img src="../../assets/img/people/chioma4.jpg" alt="" class="rounded-circle img-fluid">
                        </div>
                        <div class="col-md-8">
                            <h4 class="font-weight-bold mt-2 mb-0">Chioma Chinyere Onyehara</h4>
                            <p class="my-0">Lawyer<br>
                                <a href="chioma_oyehara.html" class="text-info">View Full Bio</a>
                            </p>
                        </div>
                    </div>
                </div>
